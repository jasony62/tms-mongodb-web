      ...
      <el-tabs type="border-card">
        <el-tab-pane label="profile">
          <el-form label-position="top" size="large">
            ...
            <el-form-item label="采样比例">
              <el-input
                type="number"
                v-model="userInput.sampleRate"
                placeholder="采样比例"
              />
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="onExecute('setProfiling')"
                >设置</el-button
              >
            </el-form-item>
          </el-form>
        ...
        <el-tab-pane label="command">
          <el-form label-position="top" size="large">
            ...
            <el-form-item>
              <el-button type="primary" @click="onExecute('runCommand')"
                >执行</el-button
              >
            </el-form-item>
          </el-form>
...
function onExecute(action: string) {
  ...
  switch (action) {
    ...
    case 'setProfiling':
      message = {
        action: PluginWidgetAction.Execute,
        result: { action, params: toRaw(userInput) },
        handleResponse: true,
      }
      break
    case 'runCommand':
