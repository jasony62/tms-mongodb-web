  ...
  >
      ...
      <el-form-item label="标签">
        ...
        >
          <el-option
            ...
            :key="tag._id"
            :label="tag.name"
            :value="{ tagId: tag._id, tagName: tag.name }"
          />
        </el-select>
      </el-form-item>
    </el-form>
    ...
    >
      <el-form-item label="集合扩展属性定义" prop="cl_schema_id">
        ...
        <el-alert
          title="通过指定【集合扩展属性定义】，给数据库下的集合添加属性字段，记录扩展业务信息。"
          type="info"
          :closable="false"
        />
      </el-form-item>
  ...
  database: {
    ...
    default: () => {
      return {
        ...
        title: '',
        description: '',
        aclCheck: DEFAULT_VALUES()?.aclCheck?.db,
        adminOnly: false,
        spreadsheet: 'no',
        tags: [],
      }
