...
import './assets/schema-editor.css'
import './assets/schema-view.css'
import './assets/document-view.css'
import './assets/prop-value-editor.css'
import './assets/json-diagram-x6.css'
import './assets/doc-preview-json.css'
