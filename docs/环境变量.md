...
| TMW_APP_CREATOR                        | 给文档添加创建人字段。                                                                                                    | creator                 |
| TMW_APP_BUCKET                         | 给文档添加 bucket 字段。                                                                                                  | bucket                  |
...
| TMW_APP_BODY_JSON_LIMIT                | 配置 提交 JSON 数据上传限制大小                                                                                           | 1mb                     |
| TMW_APP_BODY_FORM_LIMIT                | 配置提交表单数据限制大小                                                                                                  | 56kb                    |
| TMW_APP_BODY_TEXT_LIMIT                | 配置提交文本数据限制大小                                                                                                  | 56kb                    |
| TMW_APP_BODY_MAX_FILE_SIZE             | 配置文件上传限制大小                                                                                                      | 200mb                   |
| **插件（plugin.js）**                  |                                                                                                                           |                         |
