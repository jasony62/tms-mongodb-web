  ...
  <tms-frame class="tmw-collection" :display="{ header: true, footer: true, right: true }" :leftWidth="'20%'">
    ...
    <template v-slot:center>
      <tms-flex direction="column">
        <el-table :data="collections" stripe style="width: 100%" class="tms-table" @selection-change="changeClSelect"
        ...
        <tms-flex class="tmw-pagination">
          ...
          <el-pagination layout="total, sizes, prev, pager, next" background :total="clBatch.total"
            :page-sizes="[5, 50, 100, 150, 200]" :current-page="clBatch.page" :page-size="clBatch.size"
...
import ReplicaEditor from '../components/ReplicaEditor.vue.js'
