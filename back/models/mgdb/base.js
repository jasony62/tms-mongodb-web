...
class Base {
  ...
  _beforeProcessByInAndUp(data, type) {
    ...
    if (type === 'insert') {
      if (typeof data[TMSCONFIG["TMS_APP_DEFAULT_UPDATETIME"]] !== "undefined") delete data[TMSCONFIG["TMS_APP_DEFAULT_UPDATETIME"]]
      data[TMSCONFIG["TMS_APP_DEFAULT_CREATETIME"]] = current
    } else if (type === 'update') {
      if (typeof data[TMSCONFIG["TMS_APP_DEFAULT_CREATETIME"]] !== "undefined") delete data[TMSCONFIG["TMS_APP_DEFAULT_CREATETIME"]]
